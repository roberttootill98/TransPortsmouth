...
insert into Establishment (Name, Address, Town, Postcode, Description) values ("Honest Politician", "47 Elm Grove", "Portsmouth", "PO5 1JF", "A casual bar which offers cocktails, pool and darts");
insert into Establishment (Name, Address, Town, Postcode, Description) values ("Lyberry", "29-33 Guildhall Walk", "Portsmouth", "PO1 2RY", "Bar / Nightclub connected to Astoria");
